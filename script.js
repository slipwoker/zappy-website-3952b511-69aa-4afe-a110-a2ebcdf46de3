    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "New Era- Tours Education Activities משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3952b511-69aa-4afe-a110-a2ebcdf46de3',
                    name: data.name || '',
                    email: data.email || '',
